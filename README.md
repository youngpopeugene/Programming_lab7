# Доработать программу Programming_lab7 следующим образом:
...
* Для синхронизации доступа к коллекции использовать потокобезопасные аналоги коллекции из ***java.util.Collections.synchronizedXXX***.
